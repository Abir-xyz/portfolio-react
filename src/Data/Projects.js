...
const Data = [
  ...
  },
  {
    id: 4,
    title: `Streaming`,
    desc: `A web-based streaming platform that allows users to watch movies and TV shows directly from their browser.(i do not host the contents!)`,
    stacks: [
      'React',
      'React-Router',
      'Axios',
